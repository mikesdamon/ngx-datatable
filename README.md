...
It was built for modern browsers using _TypeScript, CSS3 and HTML5_ and Angular `>=4.0.0-rc1`. This is the sister project of the [angular-data-table](https://github.com/swimlane/angular-data-table) that is designed for Angular 1.x.
